...
<head> 
    ...
    <meta property="og:title" content="दीपावली की हार्दिक शुभकामनाएं" />
    <meta property="og:description" content="दीपावली की हार्दिक शुभकामनाएं" />
    <meta property="og:site_name" content="दीपावली की हार्दिक शुभकामनाएं" /> 
    <title>दीपावली की हार्दिक शुभकामनाएं</title>
...
<img src="img/dee1.png" width="25px" /><br><br>
<img src="img/dee2.png" width="25px" /><br><br>
<img src="img/dee3.png" width="25px" /><br><br>
<img src="img/dee4.png" width="25px" /><br><br>
<img src="img/dee5.png" width="25px" /><br><br>
<img src="img/dee6.png" width="25px" /><br><br>
<img src="img/dee1.png" width="25px" /><br><br>
<img src="img/dee2.png" width="25px" /><br><br>
<img src="img/dee3.png" width="25px" /><br><br>
<img src="img/dee4.png" width="25px" /><br><br>
...
<ins class="adsbygoogle"
     ...
     data-ad-client="ca-pub-7835609782166986"
     data-ad-slot="4560417725"></ins>
<script>
...
<img src="img/ki.png" width="40%" height="60px" style="animation: pulse 2s infinite"><br>
<div style="font-size: 10px; font-weight: 550; color: black;">
	 <p id="demo"></p>
</div><br>
<img src="img/main.png" width="85%" height="auto" style="animation: pulse 2s infinite"><br><br>
<img src="img/diwali-under.gif" width="40%" height="auto" style="animation: pulse 2s infinite">
<img src="img/diwali-under1.gif" width="40%" height="auto" style="animation: pulse 2s infinite">
<br>
...
<span style="font-size:22px;text-shadow: 1px 1px 3px #FFEB3B, 1px 1px 3px #FFEB3B, -1px -1px 3px #FFEB3B, -1px -1px 3px #FFEB3B;color:#E91E63;"><marquee><b><i>“ की तरफ से दीपावली की हार्दिक शुभकामनाएं!”</b></i></marquee></span><br>
...
<br><br>
<a class="footerbtn" href="whatsapp://send?text=🤗 ** ने आपके लिए कुछ भेजा है 🎁 %0A *💁 निचे ब्लू लाइन पर टच करें!* %0A  💥 🔥 😱 😱 👇 👇 %0A touch-this.co/dh/?n="><img width="25px" height="25px" src="img/whatsapp.png"/><b style="font-size: 29px;">👉 सबको भेजें 👈</b>  <img width="25px" height="25px" src="img/whatsapp.png"/>
</a>
...
// Output the result in an element with id="demo"
    document.getElementById("demo").innerHTML = days + "<font color='black'> दिन,</font> " + hours + "<font color='black'>  घंटे,</font> "
  + minutes + "<font color='black'> मिनट,</font> " + seconds + "<font color='black'> सेकंड </font> पहले ";
